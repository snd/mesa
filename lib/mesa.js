...
var Promise, helpers, mesa, mohair, phase, setQueueProperties, _, _i, _len, _ref,
  __slice = [].slice;
...
setQueueProperties = function(object, suffix) {
  ...
  return object[setterPropertyName] = function() {
    var args;
    args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    return this.fluent(dataPropertyName, this[dataPropertyName].concat(_.flatten(args)));
  };
};
...
mesa.queueBeforeEach = function() {
  ...
  ['Insert', 'Update'].forEach(function(phase) {
    ...
    return object[propertyName] = object[propertyName].concat(_.flatten(args));
  });
  return object;
};
